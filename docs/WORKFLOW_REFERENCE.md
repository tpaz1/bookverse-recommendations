...
```yaml
# JFrog Configuration
JFROG_URL: "https://tompazus.jfrog.io"
PROJECT_KEY: "bookverse"
DOCKER_REGISTRY: "tompazus.jfrog.io"
...
# Images
IMAGE_NAME: "tompazus.jfrog.io/bookverse-recommendations-internal-docker-nonprod-local/recommendations:1.2.3"
WORKER_IMAGE: "tompazus.jfrog.io/bookverse-recommendations-internal-docker-nonprod-local/recommendations-worker:1.2.4"
...
# Expected Output:
{
  ...
  "audience": "https://tompazus.jfrog.io"
}
```
